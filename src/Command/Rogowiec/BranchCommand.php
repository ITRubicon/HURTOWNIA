...
#[AsCommand(
    name: 'rogowiec:branch',
    description: 'Pobiera dane o oddziałach. Parametry: nazwa api (opcja)',
)]
class BranchCommand extends BaseApiCommand
{
    private $repo;
    protected $producerName = 'Rogowiec';

    public function __construct(BranchRepository $repo, SourceAuthRepository $apiAuthRepo, ApiFetchErrorRepository $errorRepo)
    {
