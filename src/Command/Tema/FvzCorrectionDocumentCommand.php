...
use App\Repository\Tema\FvzCorrectionDocumentRepository;
use App\Repository\Tema\FvzCorrectionItemRepository;
...
class FvzCorrectionDocumentCommand extends BaseApiCommand
{
    ...
    public function __construct(FvzCorrectionDocumentRepository $docRepo, FvzCorrectionItemRepository $itemRepo, SourceAuthRepository $apiAuthRepo, ApiFetchErrorRepository $errorRepo)
    {
