...
class TemaCommand extends Command
{
    ...
    private const COMMANDS = ['tema:schedule', 'tema:stock', 'tema:customer', 'tema:user', 'tema:rodo:type', 'tema:car', 'tema:car:order', 'tema:car:reserve', 'tema:car:stock', 'tema:fv', /* 'tema:fv:payment', */ 'tema:fv:correction', 'tema:fvz', 'tema:fvz:correction', 'tema:mm', 'tema:prepayment', 'tema:prepayment:corrections', 'tema:pz', 'tema:wz', 'tema:reserve', 'tema:service', 'tema:warehouse', 'tema:additional-cost', 'tema:service:invoice', 'tema:receipt', 'tema:wnt', /* 'tema:contact:rodo' */];
