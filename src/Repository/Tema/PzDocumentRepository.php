...
class PzDocumentRepository extends IApiRepository
{
    ...
    {
        $possessed = $this->db->fetchFirstColumn("SELECT pz_id FROM {$this->table} WHERE source = :source", ['source' => $this->source->getName()], ['source' => ParameterType::STRING]);
    ...
    {
        return [
            'pz_id' => ['sourceField' => 'id', 'type' => ParameterType::STRING],
