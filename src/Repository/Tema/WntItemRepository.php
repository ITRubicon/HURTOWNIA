...
class WntItemRepository extends IApiRepository
{
    private string $endpoint = '/api/dms/v1/intra-community-acquisition-invoice/{branchId}/{invoiceId}';
    protected $table = 'tema_wnt_document_item';
