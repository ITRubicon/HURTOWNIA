...
class WntDocumentRepository extends IApiRepository
{
    private string $endpoint = '/api/dms/v1/intra-community-acquisition-invoice/{branchId}';
    private $documentEndpoints = [];
    protected $table = 'tema_wnt_document';
    ...
    protected function getFieldsParams(): array
    {
        return [
            ...
            'purchase_document_type' => ['sourceField' => 'purchaseDocumentType', 'type' => ParameterType::STRING],
