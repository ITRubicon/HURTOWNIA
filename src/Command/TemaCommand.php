...
{
    private const COMMANDS = ['tema:stock', 'tema:customer', 'tema:rodo:type', 'tema:car', 'tema:car:reserve', 'tema:car:stock', 'tema:fv', 'tema:fv:corrections', 'tema:fvz', 'tema:fvz:correction', 'tema:mm', 'tema:order', 'tema:prepayment', 'tema:prepayment:corrections', 'tema:pz', 'tema:wz', 'tema:reserve', 'tema:service', 'tema:warehouse', 'tema:contact:rodo'];
