...
use App\Repository\Tema\WntDocumentRepository;
use App\Repository\Tema\WntItemRepository;
...
#[AsCommand(
    name: 'tema:wnt',
    description: 'Pobiera faktury wewnątrzwspólnotowe nabycia i pozycje z nich. Parametry: nazwa api (opcja)',
)]
class WntDocumentCommand extends BaseApiCommand
{
    private $docRepo;
    private $itemRepo;
    protected $producerName = 'Tema';

    public function __construct(WntDocumentRepository $docRepo, WntItemRepository $itemRepo, SourceAuthRepository $apiAuthRepo, ApiFetchErrorRepository $errorRepo)
    {
    ...
    protected function fetch(IConnection $api, SymfonyStyle &$io)
    {
        ...
        $dateFrom = new \DateTime('first day of 1 months ago');
        $dateTo = new \DateTime();
