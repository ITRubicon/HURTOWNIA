...
use App\Repository\Tema\StockRepository;
...
#[AsCommand(
    name: 'tema:stock',
    description: 'Pobiera listę magazynów. Parametry: nazwa api (opcja)',
)]
class StockCommand extends BaseApiCommand
{
    private $repo;
    protected $producerName = 'Tema';

    public function __construct(StockRepository $repo, SourceAuthRepository $apiAuthRepo, ApiFetchErrorRepository $errorRepo)
    {
