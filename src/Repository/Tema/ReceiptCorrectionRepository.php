...
class ReceiptCorrectionRepository extends IApiRepository
{
    private string $endpoint = '/api/dms/v1/receipt-corrections/{branchId}/:sync';
    protected $table = 'tema_receipt_correction';
